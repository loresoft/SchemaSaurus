...
public class DatabaseInitializer : IHostedService
{
    ...
    {
        _logger.LogInformation("Ensuring target database 'SchemaSaurus' exists...");
        ...
        command.CommandText = "CREATE DATABASE IF NOT EXISTS `SchemaSaurus`;";

        command.ExecuteNonQuery();

        command.CommandText = $"GRANT ALL PRIVILEGES ON `SchemaSaurus`.* TO '{userId}'@'%';";
